...
var frequencyBtn = document.querySelectorAll('.section-1__frequency');
var secondSection = document.querySelector('.section-2');
...
function eventListeners() {
  frequencyBtn.forEach(function (btn) {
...
function createCard(element, timeframe) {
  ...
  var current = element['timeframes'][timeframe]['current'];
  var previous = element['timeframes'][timeframe]['previous'];
  var timeframesMsg = {
    'daily': 'Yesterday',
    'weekly': 'Last Week',
    'monthly': 'Last Month'
  };
  return "\n    <article class=\"section-2__card\">\n        <header class=\"section-2__header\">\n            <img src=\"assets/svg/icon-".concat(title == 'self care' ? title.replace(' ', '-') : title.replace('-', ' '), ".svg\" alt=\"icon\" class=\"section-2__icon\">\n        </header>\n\n        <div class=\"section-2__details\">\n            <section class=\"section-2__activity\">\n                <p class=\"section-2__title\">").concat(title, "</p>\n                <img src=\"assets/svg/icon-ellipsis.svg\" alt=\"three dots\">\n            </section>\n            <section class=\"section-2__description\">\n                <h2 class=\"section-2__hours\">").concat(current, "hrs</h2>\n                <p class=\"section-2__weeks\">").concat(timeframesMsg[timeframe], " - ").concat(previous, "hrs</p>\n            </section>\n        </div>\n    </article>\n    \n    ");
}
...
function updateCard(card, timeFrame) {
  ...
  var title = card.querySelector('.section-2__title').innerText;
  var current = data[title][timeframe]['current'];
  var previous = data[title][timeframe]['previous'];
  var hoursElement = card.querySelector('.section-2__hours');
  hoursElement.innerText = "".concat(current, "hrs");
  var weekElement = card.querySelector('.section-2__weeks');
  weekElement.innerText = "".concat(timeframesMsg[timeFrame], " - ").concat(previous, "hrs");
}